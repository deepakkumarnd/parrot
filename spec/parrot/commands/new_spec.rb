...
describe Parrot::Commands do
  ...
  context 'NewCommand' do
    ...
    it 'creates a blog application' do
      ...
      file_list = %w[blog/css/app.scss blog/javascripts/app.js blog/images/favicon.ico blog/images/favicon.svg blog/images/apple-touch-icon.png blog/images/parrot.jpeg blog/views/layout.html.erb blog/views/404.md blog/views/posts/post1.md blog/views/posts/post2.md blog/config.yaml blog/public/.keep]
